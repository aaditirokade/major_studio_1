...
d3.json('data/africa.geo.json').then((geojson) => {
    d3.json('data/allPOPData.json').then((pop)=>{
         d3.json('data/allENERGYData.json').then((eng)=>{
    	       ...
    	       //  var combined = eng.filter((singleEng) => {
        ...
        let svg = (data) => {
          ...
          //console.log('ppur2012');console.log(data.ppur2012);
	       ...
	       //let modal = graph.append('g').attr('id', 'modal');
            ...
            // 2012 EMPTY BARS
            bar12.append('rect')
                 .attr('width', 300).attr('height', '3px')
                 .attr('x',0).attr('y', 0)
            ...
            // 2012 BARS
            bar12.append('rect')
                 .attr('width', (d,i) =>{return d*3;}).attr('height', '3px')
                 .attr('x',0).attr('y', 0)
            ...
            // 2013 SELECTION VAR
             let bar13 = group3.selectAll('g').data(e13).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${window.innerWidth/2+70}, ${i * 3000/data.length+49})`;})
            ...
            // 2014 SELECTION VAR
             let bar14 = group4.selectAll('g').data(e14).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${window.innerWidth/2+70}, ${i * 3000/data.length+52})`;})
            ...
            // 2015 SELECTION VAR
             let bar15 = group5.selectAll('g').data(e15).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${window.innerWidth/2+70}, ${i * 3000/data.length+55})`;})
            ...
            // 2016 SELECTION VAR
             let bar16 = group6.selectAll('g').data(e16).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${window.innerWidth/2+70}, ${i * 3000/data.length+58})`;})
            ...
            // 2016 BARS
            bar16.append('rect')
                 .attr('width', (d,i) =>{return d*3;}).attr('height', '3px')  // TODO
                 .attr('x',0).attr('y', 0)
            ...
            //         .attr('transform', (d, i) => {return `translate(${(window.innerWidth/2-50)-d/1000000}, ${i * 3000/data.length+46})`;})
            ...
            // 2012 BARS
            bar17.append('rect')
                 .attr('width', (d,i) =>{return d/1000000;}).attr('height', '3px')
                 .attr('x',0).attr('y', 0)
            ...
            // 2013 SELECTION VAR
             let bar18 = group8.selectAll('g').data(p13).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${(window.innerWidth/2-50)-d/1000000}, ${i * 3000/data.length+49})`;})
            ...
            // 2014 SELECTION VAR
             let bar19 = group9.selectAll('g').data(p14).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${(window.innerWidth/2-50)-d/1000000}, ${i * 3000/data.length+52})`;})
            ...
            // 2015 SELECTION VAR
             let bar110 = group10.selectAll('g').data(p14).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${(window.innerWidth/2-50)-d/1000000}, ${i * 3000/data.length+55})`;})
            ...
            // 2016 SELECTION VAR
             let bar111 = group11.selectAll('g').data(p14).enter().append('g')
                    .attr('transform', (d, i) => {return `translate(${(window.innerWidth/2-50)-d/1000000}, ${i * 3000/data.length+58})`;})
