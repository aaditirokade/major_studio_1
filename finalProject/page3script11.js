               ...
               // ENERGY ACCESS LEGENDS
                ...
                label.append('a').attr("xlink:href", "https://vfs.cloud9.us-east-1.amazonaws.com/vfs/a781720202c74ba080f5141c784fc66b/preview/assignment3/page1/index3.html")
            ...
            if(inText=='RURAL')
              {     
                     ...
                     //******* ELECTRICITY RURAL ******* 
                           ...
                           // 2012 BARS
                           bar12.append('rect')
                                .attr('width', (d,i) =>{ if(d.eleRural2012==='NA')d.eleRural2012=0; return d.eleRural2012*3;}).attr('height', '5px')
                                .attr('x',0).attr('y', 0).style('fill','#Ffe168')
                                .on('mouseover',(d)=>{
                                    // document.getElementById('tooltip').style.visibility='visible';
                                     // TOOLTIP
                                     div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
                                     div.html( d.countryName.toUpperCase() + '<br> 2012 : '+ d.eleRural2012.toFixed(2)+'%' + '<br>2013 : '+ d.eleRural2013.toFixed(2) +'%'+ '<br>2014 : '+ d.eleRural2014.toFixed(2) +'%'+ '<br>2015 : '+ d.eleRural2015.toFixed(2) +'%'+ '<br>2016 : '+ d.eleRural2016.toFixed(2)+'%')
                           ...
                           // 2016 BARS
                           bar16.append('rect')
                                .attr('width', (d,i) =>{if(d.eleRural2016==='NA')d.eleRural2016=0; return d.eleRural2016*3;}).attr('height', '5px')  // TODO
                     ...
                     //******* POPULATION RURAL ******* 
                           ...
                           // 2012 SELECTION VAR
                            let bar17 = group1.append('g').attr('id', 'group7').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppru2012==='NA')d.ppru2012=0; return `translate(${(window.innerWidth/2-50)-(d.ppru2012*3)}, ${i * 3000/data.length+46})`;});
                                
                   
                           // 2012 BARS
                           bar17.append('rect').attr('class', 'rect6').attr('width', (d,i) =>{if(d.ppru2012==='NA')d.ppru2012=0; return d.ppru2012*3;}).attr('height', '5px')
                                .attr('x',0).attr('y', 0).style('fill','#94d8e8')
                                .on('mouseover',(d)=>{
                                    // TOOLTIP
                                    div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
                                    div.html(d.countryName.toUpperCase() + '<br> 2012 : '+ d.ppru2012.toFixed(2)+'%' + '<br>2013 : '+ d.ppru2013.toFixed(2) +'%'+ '<br>2014 : '+ d.ppru2014.toFixed(2) +'%'+ '<br>2015 : '+ d.ppru2015.toFixed(2) +'%'+ '<br>2016 : '+ d.ppru2016.toFixed(2)+'%')
                                    .style("left", (d3.event.pageX) + "px").style("top", (d3.event.pageY - 28) + "px");
                                })
                                .on('mouseout',(d)=>{
                                    document.getElementById('tooltip').style.visibility='hidden';
                           ...
                           // 2013 SELECTION VAR
                            let bar18 = group1.append('g').attr('id', 'group8').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppru2013==='NA')d.ppru2013=0; return `translate(${(window.innerWidth/2-50)-(d.ppru2013*3)}, ${i * 3000/data.length+51})`;})
                           
                           // 2013 BARS
                           bar18.append('rect').attr('class', 'rect7').attr('width', (d,i) =>{if(d.ppru2013==='NA')d.ppru2013=0; return d.ppru2013*3;}).attr('height', '5px')
                           ...
                           // 2015 SELECTION VAR
                            let bar110 = group1.append('g').attr('id', 'group10').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppru2015 === 'NA') d.ppru2015 = 0; return `translate(${(window.innerWidth/2-50) - (d.ppru2015*3)}, ${i * 3000/data.length+61})`;})
                           
                           // 2015 BARS
                           bar110.append('rect').attr('class', 'rect9').attr('width', (d,i) =>{ if(d.ppru2015 === 'NA') d.ppru2015 = 0; return d.ppru2015*3;}).attr('height', '5px')
                           ...
                           // 2016 SELECTION VAR
                            let bar111 = group1.append('g').attr('id', 'group11').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppru2016 === 'NA') d.ppru2016 = 0; return `translate(${(window.innerWidth/2-50) - (d.ppru2016)*3}, ${i * 3000/data.length+66})`;})
                           
                           // 2016 BARS
                           bar111.append('rect').attr('class', 'rect10').attr('width', (d,i) =>{ if(d.ppru2016 === 'NA') d.ppru2016 = 0; return d.ppru2016*3;}).attr('height', '5px')
             ...
             // document.getElementById('group1').style.visibility= 'hidden';
                    ...
                    //******* ELECTRICITY URBAN ******* 
                           ...
                           // 2012 BARS
                           bar12.append('rect')
                                .attr('width', (d,i) =>{ if(d.eleUrban2012==='NA')d.eleUrban2012=0; return d.eleUrban2012*3;}).attr('height', '5px')
                                .attr('x',0).attr('y', 0).style('fill','#Ffe168')
                                .on('mouseover',(d)=>{
                                     // TOOLTIP
                                     div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
                                      div.html( d.countryName.toUpperCase() + '<br> 2012 : '+ d.eleUrban2012.toFixed(2)+'%' + '<br>2013 : '+ d.eleUrban2013.toFixed(2) +'%'+ '<br>2014 : '+ d.eleUrban2014.toFixed(2) +'%'+ '<br>2015 : '+ d.eleUrban2015.toFixed(2) +'%'+ '<br>2016 : '+ d.eleUrban2016.toFixed(2)+'%')
                                     .style("left", (d3.event.pageX) + "px").style("top", (d3.event.pageY - 28) + "px");
                                })
                                .on('mouseout',(d)=>{
                                    document.getElementById('tooltip').style.visibility='hidden';
                           ...
                           // 2016 BARS
                           bar16.append('rect')
                                .attr('width', (d,i) =>{ if(d.eleUrban2016==='NA')d.eleUrban2016=0; return d.eleUrban2016*3;}).attr('height', '5px')  // TODO
                                .attr('x',0).attr('y', 0).style('fill','#e49307')
                                .on('mouseover',(d)=>{
                                      // TOOLTIP
                                      div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
                     ...
                     //******* POPULATION URBAN ******* 
                           ...
                           // 2012 SELECTION VAR
                            let bar17 = group1.append('g').attr('id', 'group7').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppur2012==='NA')d.ppur2012=0; return `translate(${(window.innerWidth/2-50)-(d.ppur2012*3)}, ${i * 3000/data.length+46})`;});
                                
                           // 2012 BARS
                           bar17.append('rect').attr('class', 'rect6').attr('width', (d,i) =>{ if(d.ppur2012==='NA')d.ppur2012=0; return d.ppur2012*3;}).attr('height', '5px')
                                .attr('x',0).attr('y', 0).style('fill','#94d8e8')
                                .on('mouseover',(d)=>{
                                    // TOOLTIP
                                    div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
                                    div.html(d.countryName.toUpperCase() + '<br> 2012 : '+ d.ppur2012.toFixed(2)+'%' + '<br>2013 : '+ d.ppur2013.toFixed(2) +'%'+ '<br>2014 : '+ d.ppur2014.toFixed(2) +'%'+ '<br>2015 : '+ d.ppur2015.toFixed(2) +'%'+ '<br>2016 : '+ d.ppur2016.toFixed(2)+'%')
                                    .style("left", (d3.event.pageX) + "px").style("top", (d3.event.pageY - 28) + "px");
                                })
                                .on('mouseout',(d)=>{
                                    document.getElementById('tooltip').style.visibility='hidden';
                           ...
                           // 2013 SELECTION VAR
                            let bar18 = group1.append('g').attr('id', 'group8').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppur2013==='NA')d.ppur2013=0; return `translate(${(window.innerWidth/2-50)-(d.ppur2013*3)}, ${i * 3000/data.length+51})`;})
                           
                           // 2013 BARS
                           bar18.append('rect').attr('class', 'rect7').attr('width', (d,i) =>{ if(d.ppur2013==='NA')d.ppur2013=0; return d.ppur2013*3;}).attr('height', '5px')
                                .attr('x',0).attr('y', 0).style('fill','#4dbfd9')
                                .on('mouseover',(d)=>{
                                      // TOOLTIP
                                      div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
                           ...
                           // 2015 SELECTION VAR
                            let bar110 = group1.append('g').attr('id', 'group10').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppur2015==='NA')d.ppur2015=0; return `translate(${(window.innerWidth/2-50) - (d.ppur2015*3)}, ${i * 3000/data.length+61})`;})
                           
                           // 2015 BARS
                           bar110.append('rect').attr('class', 'rect9').attr('width', (d,i) =>{ if(d.ppur2015==='NA')d.ppur2015=0; return d.ppur2015*3;}).attr('height', '5px')
                                .attr('x',0).attr('y', 0).style('fill','#15a0d9')
                                .on('mouseover',(d)=>{
                                      // TOOLTIP
                                      div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
                           ...
                           // 2016 SELECTION VAR
                            let bar111 = group1.append('g').attr('id', 'group11').selectAll('g').data(data).enter().append('g')
                                   .attr('transform', (d, i) => { if(d.ppur2016==='NA')d.ppur2016=0; return `translate(${(window.innerWidth/2-50) - (d.ppur2016)*3}, ${i * 3000/data.length+66})`;})
                           
                           // 2016 BARS
                           bar111.append('rect').attr('class', 'rect10').attr('width', (d,i) =>{ if(d.ppur2016==='NA')d.ppur2016=0; return d.ppur2016*3;}).attr('height', '5px')
                                .attr('x',0).attr('y', 0).style('fill','#1c91d0')
                                .on('mouseover',(d)=>{
                                      // TOOLTIP
                                      div.transition().duration(30).style("opacity", 1).style("visibility", 'visible');
